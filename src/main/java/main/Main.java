 ...
 * The Inventory Management system is an application created for the purpose of managing
  parts and products. Parts and Products are added to lists and can be associated.
 ...
 **/
 ...
 /** FUTURE ENHANCEMENT
 *
 * If a new version were to be released, the application should save data after being run for the next use.
 ...
 * Several Runtime Errors occurred when non integers were entered into integer only text-fields.The application would often crash with a NUMBERFORMATEXCEPTION error.
